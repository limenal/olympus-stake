...
import { DAIBOND_TOKEN, OHM_ERC20_CONTRACT, DAIBOND_CONTRACTS1} from './utils/Constants'
...
export function handleBondCreate(event: BondCreated) : void{
  ...
  deposit.ohmReserve = toDecimal(ohm_contract.balanceOf(Address.fromString(DAIBOND_CONTRACTS1)), 9)
...
export function handleBondRedeem(event: BondRedeemed) : void{
  ...
  redeem.ohmReserve = toDecimal(ohm_contract.balanceOf(Address.fromString(DAIBOND_CONTRACTS1)), 9)
