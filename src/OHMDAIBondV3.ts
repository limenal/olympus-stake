...
import {  DepositCall, RedeemCall, BondCreated, BondRedeemed, BondPriceChanged} from '../generated/OHMDAIBondV3/OHMDAIBondV3'
...
export function handleBondCreate(event: BondCreated) : void{
  ...
  deposit.ohmReserve = toDecimal(ohm_contract.balanceOf(Address.fromString(OHMDAISLPBOND_CONTRACT3)), 9)
...
export function handleBondRedeem(event: BondRedeemed) : void{
  ...
  redeem.ohmReserve = toDecimal(ohm_contract.balanceOf(Address.fromString(OHMDAISLPBOND_CONTRACT3)), 9)
