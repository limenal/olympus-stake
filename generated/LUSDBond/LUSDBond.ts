...
export class LUSDBond__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LUSDBond__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LUSDBond__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class LUSDBond extends ethereum.SmartContract {
  static bind(address: Address): LUSDBond {
    return new LUSDBond("LUSDBond", address);
  }
  ...
  adjustment(): LUSDBond__adjustmentResult {
    ...
    return new LUSDBond__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<LUSDBond__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new LUSDBond__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): LUSDBond__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new LUSDBond__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(param0: Address): ethereum.CallResult<LUSDBond__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  terms(): LUSDBond__termsResult {
    ...
    return new LUSDBond__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<LUSDBond__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
