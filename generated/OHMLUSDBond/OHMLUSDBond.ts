...
export class OHMLUSDBond__adjustmentResult {
  value0: boolean;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBond__bondInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBond__termsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OHMLUSDBond extends ethereum.SmartContract {
  static bind(address: Address): OHMLUSDBond {
    return new OHMLUSDBond("OHMLUSDBond", address);
  }
  ...
  adjustment(): OHMLUSDBond__adjustmentResult {
    ...
    return new OHMLUSDBond__adjustmentResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_adjustment(): ethereum.CallResult<OHMLUSDBond__adjustmentResult> {
    ...
    return ethereum.CallResult.fromValue(
      new OHMLUSDBond__adjustmentResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  bondInfo(param0: Address): OHMLUSDBond__bondInfoResult {
    let result = super.call(
      "bondInfo",
    ...
    return new OHMLUSDBond__bondInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_bondInfo(
    param0: Address
  ): ethereum.CallResult<OHMLUSDBond__bondInfoResult> {
    let result = super.tryCall(
      "bondInfo",
      "bondInfo(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OHMLUSDBond__bondInfoResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  terms(): OHMLUSDBond__termsResult {
    let result = super.call(
      "terms",
    ...
    return new OHMLUSDBond__termsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_terms(): ethereum.CallResult<OHMLUSDBond__termsResult> {
    let result = super.tryCall(
      "terms",
      "terms():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
